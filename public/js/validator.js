...
container.on('input.bs.validator change.bs.validator focusout.bs.validator', Validator.INPUT_SELECTOR, $.proxy(this.onInput, this));
container.on('submit.bs.validator', this.$element, $.proxy(this.onSubmit, this));

this.$element.find('[data-match]').each(function () {
var $this  = $(this);
var target = $this.data('match');

container.on('input.bs.validator', target, function (e) {
